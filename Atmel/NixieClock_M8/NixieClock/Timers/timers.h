...
#define Timer_Overvlow_Vector			TIMER0_COMPA_vect

#define Timer_TCCR_A_Setting			(1 << WGM01)
#define Timer_TCCR_B_Setting			Timer_Prescale

//Set the correct Timer Counter Control Register (TCCR)
#define Timer_TCCR_A					TCCR0A //timer configuration
#define Timer_TCCR_B					TCCR0B //Timer configuration

//Set the correct Timer Interrupt Mask Register
#define Timer_TIMSK						TIMSK0
#define Timer_Overflow_Interrupt		OCIE0A

//Set the correct Timer CouNter Register
#define Timer_Counter_Register			OCR0A
