...
typedef struct{
	uint8_t eDate_Show;
	uint8_t eDate_Timeout_SV;
	uint8_t eDate_Show_SV;
	uint8_t eSave_Active;
	uint16_t eSave_Off_Threshold;
	uint16_t eSave_On_Threshold;
	RTC_time_struct eSave_Time_OFF;
	RTC_time_struct eSave_Time_ON;
	uint16_t eSave_Timeout_SV;
	uint8_t eSave_IS_PM;
	uint8_t eRoll_Active;
	uint8_t	eFade;
	uint8_t eFade_Time;
	uint8_t eColon_Active;
	uint8_t eNixie_Amount;
}Nixie_EEPROM_STruct;
...
typedef struct{
	...
	uint8_t Save_Time_OFF_PM;
	RTC_time_struct Save_Time_ON;
	uint8_t Save_Time_ON_PM;
	...
	uint8_t Fade;
	uint8_t Fade_Time;
	uint8_t Colon_Active;
	uint8_t Nixie_Amount;
...
typedef struct{
	...
	uint8_t Hour_One;
	uint8_t Hour_Ten;
	uint8_t Second_One_Old;
	uint8_t Second_Ten_Old;
	uint8_t Minute_One_Old;
	uint8_t Minute_Ten_Old;
	uint8_t Hour_One_Old;
	uint8_t Hour_Ten_Old;
	uint8_t Fade_Step;
	uint8_t Faded_time;
	uint8_t Fade_Timer_On;
	uint8_t Fade_Timer_Off;
	RTC_time_struct Time_Old;
